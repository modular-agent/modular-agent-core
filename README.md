...
> [modular-agent monorepo](https://github.com/modular-agent/modular-agent), under [`crates/modular-agent-core`](https://github.com/modular-agent/modular-agent/tree/main/crates/modular-agent-core).
>
